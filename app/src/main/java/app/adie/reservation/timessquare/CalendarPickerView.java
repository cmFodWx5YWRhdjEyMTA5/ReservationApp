...
import app.adie.reservation.timessquare.MonthCellDescriptor.RangeState;
...
public class CalendarPickerView extends ListView {
  ...
  public String titleMonths(int month) {
    return new String[]{"Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"}[month];
  }
